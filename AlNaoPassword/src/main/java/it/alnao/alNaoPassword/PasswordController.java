...
public class PasswordController
{
	...
	public ResponseEntity<?> echo(){
		logger.info("****** PasswordService echo *******");
	...
	public ResponseEntity<List<PasswordEntities>> getPassword(HttpServletRequest httpRequest) throws Exception{
		logger.info("****** PasswordService getPassword *******");
		
		List<PasswordEntities> l;
		l=this.service.selTutti();

		return new ResponseEntity<List<PasswordEntities>>(l, HttpStatus.OK);
	}
	/*
	// ------------------- Ricerca Per Codice ------------------------------------
