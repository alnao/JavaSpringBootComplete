...
import it.alnao.AuthServer.security.JwtTokenUtil;
...
public class JwtAuthenticationRestController 
{
	...
	{
		logger.info("Autenticazione e Generazione Token"+ authenticationRequest.getUsername() + authenticationRequest.getPassword());
